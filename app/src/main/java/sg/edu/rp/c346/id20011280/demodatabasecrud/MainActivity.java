...
public class MainActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        btnAdd.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v)
            {
                ...
                DBHelper dbh = new DBHelper(MainActivity.this); // calling the db helper

                long inserted_id = dbh.insertNote(data);

                if (inserted_id != -1){  // if there is data
                    al.clear();
                    al.addAll(dbh.getAllNotes()); // add all the notes in database
        ...
        btnRetrieve.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                al.clear(); // dont add in the existing
        ...
        btnEdit.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Note target = al.get(0); //first objec tin arraylist
    ...
    protected void onResume() {
        ...
        btnRetrieve.performClick(); // program clicks the button
    }
